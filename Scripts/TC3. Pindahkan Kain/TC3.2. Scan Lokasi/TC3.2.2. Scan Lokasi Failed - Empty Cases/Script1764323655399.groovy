...
Mobile.tap(findTestObject('Application/App/Activity/Pemindahan Kain Rollan - Page/Scan No Lokasi/Scan Lokasi - Button Submit'), 
    0)

Mobile.verifyElementExist(findTestObject('Application/App/Activity/Pemindahan Kain Rollan - Page/Scan No Lokasi/Toast Lokasi Tidak Boleh Kosong'), 
    0)
